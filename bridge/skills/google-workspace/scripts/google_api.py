#!/usr/bin/env python3
"""Google Workspace API CLI for YHA.
...
def get_credentials():
    ...
    # Load credentials from file without passing scopes to from_authorized_user_file
    # (scopes parameter can cause ValueError with certain OAuth flows)
...
def main():
    parser = argparse.ArgumentParser(description="Google Workspace API for YHA")
