// masterPrompt.ts — System-style prompt that teaches the LLM to output a YHA workflow as a single
// fenced markdown block. The user appends a free-form task description below the
// "WORKFLOW DESCRIPTION:" footer; the LLM responds with a complete .md file the user can
// download and re-import via the "⤴ MD" button in the workflow picker.

export const WORKFLOW_MASTER_PROMPT = `<!-- yha-workflow-md v1 -->
